...
**Condensador:** Este conductor **no almacena energia** este almacena un **campo electrico** para luego convertilo en **energia cinetica.** Cuando almacena el campo electrico para crear la energia los electrones se desplazan esto produce una carga electrica y un campo magnetico esto crea electricidad por el movimiento de los electrones. 
